    ...
    return(
        ...
        <div className="container-fluid relative mt-20">
            <div className="grid grid-cols-1">
                <div className="w-full leading-[0] border-0" id="googlemap">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3889.02444743808!2d77.57679097507535!3d12.906149487403216!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae156c243fec4d%3A0x1a473f0d02155ee!2siFocus%20Systec!5e0!3m2!1sen!2sin!4v1748414274604!5m2!1sen!2sin" title="my-map" style={{border:"0"}} className="w-full h-[500px]" allowFullScreen></iframe>
                </div>
            </div>
        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                    <div className="text-center px-6">
                        ...
                        <div className="content mt-7">
                            ...
                            <div className="mt-5">
                                <Link to="tel:+91 9071234513" className="hover:text-amber-400">+91 9071234513</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-center px-6">
                        ...
                        <div className="content mt-7">
                            ...
                            <div className="mt-5">
                                <Link to="mailto:contact@example.com" className="hover:text-amber-400">support@qwikhire.ai</Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-center px-6">
                        ...
                        <div className="content mt-7">
                            ...
                            {/* <div className="mt-5">
                                <Link to="#contact"
                                 className="video-play-icon read-more lightbox hover:text-amber-400">View on Google map</Link>
                            </div> */}
                        </div>
                    </div>
                </div>
