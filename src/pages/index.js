        ...
        <section className="relative overflow-hidden pt-48 after:content-[''] after:absolute after:inset-0 after:mx-auto after:w-[56rem] after:h-[56rem] after:bg-gradient-to-tl after:to-amber-400/30  after:from-fuchsia-600/30 dark:after:to-amber-400/50 dark:after:from-fuchsia-600/50 after:blur-[200px] after:rounded-full after:-z-1">
            <div className="container relative z-2">
                <div className="grid grid-cols-1 text-center">
                    <div className="">
                        <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-6xl mb-5">Hire Smarter with <br/> Qwikhire.ai for 
                            <TypeAnimation
                                sequence={[
                        ...
                        <p className="text-slate-400 dark:text-white/60 text-lg max-w-xl mx-auto">Just sit and relax, let our AI Interviewer take care of picking perfect fit candidate for you</p>
        ...
        <section className="relative md:py-24 py-16">
            ...
            <div className="container relative md:mt-24 mt-16">
                <div className="grid grid-cols-1 pb-6 text-center">
                    <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Pricing made simple, <br/> <span className="bg-gradient-to-br from-amber-400 to-fuchsia-600 text-transparent bg-clip-text"> plans made perfect</span></h3>

                    <p className="text-slate-400 max-w-xl mx-auto">Choose a plan that fits your unique hiring needs perfectly. Our pricing is transparent, flexible, and designed to deliver real value.</p>
                </div>
                <Pricing/>
            </div>
