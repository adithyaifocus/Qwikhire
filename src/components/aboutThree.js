    ...
    return(
        ...
        <div className="container relative md:mt-24 mt-16">
                <div className="grid md:grid-cols-2 grid-cols-1 items-center gap-6">
                    ...
                    <div className="">
                        <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Turn voice into high-quality <br/> textovers with excellent speech recognization</h3>
                        <p className="text-slate-400 max-w-xl">"Usually in F2F interviews people sit and listen to what the candidate say, take some break, we have our specialized AI to hear and grasp the content."</p>

                        <ul className="list-none text-slate-400 mt-4">
                            <li className="mb-2 flex items-center"><FiCheckCircle className="text-amber-400 h-5 w-5 me-2"/> Powered by advanced AI for better transcription quality.</li>
                            <li className="mb-2 flex items-center"><FiCheckCircle className="text-amber-400 h-5 w-5 me-2"/> Supports multiple accents</li>
                            <li className="mb-2 flex items-center"><FiCheckCircle className="text-amber-400 h-5 w-5 me-2"/> Real time voice recognization</li>
                        </ul>
